...
O padrão operacional de tabelas, estados, retentativas, DLQ e observabilidade da Outbox está definido no [Padrão Outbox por Serviço](../docs/architecture/outbox-pattern.md).
