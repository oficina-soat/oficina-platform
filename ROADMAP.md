...
As validações remotas prioritárias restantes, quando os respectivos pré-requisitos estiverem concluídos e o ambiente externo estiver disponível, são `[D-NR-REM-004]`, `[D-NR-REM-006]` e os itens `EVID` finais.
