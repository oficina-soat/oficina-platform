...
A homologação anterior no `lab` comprovou os caminhos aprovado e recusado, o bloqueio da transição direta e o consumo único real. Expiração, concorrência, ação incompatível e indisponibilidade permanecem cobertas por testes automatizados. O link único, o reenvio e a invalidação do link anterior aguardam o rollout coordenado registrado no [roadmap](../../ROADMAP.md).
