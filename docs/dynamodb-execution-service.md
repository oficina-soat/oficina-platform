...
Os nomes acima são nomes lógicos por ambiente. A infraestrutura pode prefixar ou sufixar ambiente conforme `docs/infra-runtime-naming.md`, desde que preserve o nome lógico e o ownership.
