...
As validações remotas prioritárias restantes, quando o ambiente externo estiver disponível, são `[B2-GH-REM-001]`, `[D-NR-REM-002]` a `[D-NR-REM-004]` e os itens `EVID` finais.
